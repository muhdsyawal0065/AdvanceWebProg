                                ...
                                <div style="position: relative; padding:20px; right:0px">
                                    <table bgcolor="white">
                                        <tr style="font-size: 12px; text-align:center">
                                            ...
                                            <th style="padding:20px; width:200px;">Operation</th>
                                        ...
                                        <tr align="center" style="font-size: 12px;">    
                                            ...
                                            <td style="font-size: 10px;" ; class="button button2"><a href={{"del/".$x['id']}}> DELETE </td>
                                            <td style="font-size: 10px;" ; class="button button1"><a href={{"upd/".$x['id']}}> UPDATE </td>
                                        </tr>
                                        @endforeach
                                    </table><br>
                                    <div class="d-flex">
